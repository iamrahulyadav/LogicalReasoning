...
import app.reasoning.logical.quiz.craftystudio.logicalreasoning.MainActivity;
import app.reasoning.logical.quiz.craftystudio.logicalreasoning.R;
import app.reasoning.logical.quiz.craftystudio.logicalreasoning.TopicQuestions;
...
public class FireBasePushNotificationService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
             ...
             intent = new Intent(this, TopicQuestions.class);
